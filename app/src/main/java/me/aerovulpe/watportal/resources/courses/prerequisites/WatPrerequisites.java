...
public class WatPrerequisites{
    ...
    public static class Data{
           ...
           private List<Prerequisites> prerequisites_parsed;
        ...
        public void setPrerequisites(String prerequisites){
         ...
         public List<Prerequisites> getPrerequisites_parsed(){
            return this.prerequisites_parsed;
        }
        public void setPrerequisites_parsed(List<Prerequisites> prerequisites_parsed){
